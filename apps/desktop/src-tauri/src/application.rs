...
pub fn run() {
    ...
    application_builder
        .setup(|app| {
            crate::api::application_startup::initialize(app)?;
        ...
        .invoke_handler(tauri::generate_handler![
            crate::api::application_configuration::get_application_config_value_by_key,
            crate::api::application_configuration::set_application_config_value,
            crate::api::application_startup::wait_for_background_ready,
            crate::api::application_startup::set_window_appearance,
            crate::api::application_startup::set_window_interactive_regions
        ])
